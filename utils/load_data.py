...
def load_train_val_test_split(data_file: str, n_rows: int = None, frac_val: float = 0.2,
                              frac_test: float = 0.2, drop_original_targets: bool = True,
                              booking_score: int = 5, clicking_score: int = 1, seed: int = 420) -> tuple[
    ...
    # `Create targets`
    df = add_target_column(df, booking_score=booking_score, clicking_score=clicking_score)
